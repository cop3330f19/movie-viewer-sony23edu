...
public class FXMLController implements Initializable {
    ...
    @FXML
    //Changing screen; changing the info that appear on the scene
    ...
    //see a list of all the poster
    private void loadInitialScene(){
        
        //create a scoll pane; Main scrollable area
        ScrollPane scpMain = new ScrollPane();
        
        //Create a gridPane
        GridPane posterGrid = new GridPane();
        
        //Get movie from omvie model
        Movies movieList = new Movies();
        //Make a call to GET movies
        movies = movieList.getMovies();
        
        int i = 0, col = 0, row = 0;
        
        
        //For each movieDb object inside our movielist, first create image
     ...
     private void loadDetailScene(int current) {
         ...
         content = "<iframe width=\"660\" height=\"415\" src=\"https://www.youtube.com/embed/WaYAhkH2cJM\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>    ";
